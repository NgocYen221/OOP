...
public class Mainn {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        DuAn da2 = new DuAn("C", "22/03/2002", "22/03/2003", 15);
        DuAn da3 = new DuAn("D", "22/04/2002", "22/04/2003", 25);
        
        qlda.themDuAn(da, da0, da1, da2, da3);
//
...
//        qlda.timDuAnTheoNgayBatDau().forEach(s -> System.out.println(s));
        ...
        NhanVien nv = new NhanVienThuong("Nguyen A", "Nu", "22/7/2012", "abc@gmail.com");
...
//        
        qlnv.themNV(nv, nv1, nv2, nv3, nv4);
//        qlnv.hienThi();
//        qlnv.hienThiDsTn(2);
//       
        String tenDuAn;
        ...
        do {
            ...
            System.out.println("5.Tim kiem du an theo ten/thoi gian bat dau");
            ...
            System.out.println("8.Xuat danh sach than nhan theo ma nhan vien");
...
//                                System.out.println(qlnv.timKiemNhanVien(tennv));
                ...
                case 7:
                    ...
                    break;
                case 8:
                    // Xuat danh sach than nhan theo ma nhan vien
